...
const Community = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-200 pt-16 overflow-hidden">
      <header className="h-14 bg-gray-200 flex items-center justify-between px-4 fixed w-full top-0">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="p-2 bg-blue-500 text-white rounded">로그인</button>
        </div>
      </header>
